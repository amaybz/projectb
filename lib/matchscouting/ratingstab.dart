...
class _RatingsTabState extends State<RatingsTab> {
  ...
  final List<DropDownValue> listDefenceType = [
    DropDownValue(id: "1", value: "N/A"),
    DropDownValue(id: "2", value: "Block Reload"),
    DropDownValue(id: "3", value: "Block Scoring"),
    DropDownValue(id: "4", value: "Block Movement"),
    DropDownValue(id: "5", value: "Multiple"),
  ];

  final List<DropDownValue> listAccess = [
    DropDownValue(id: "1", value: "N/A"),
    DropDownValue(id: "2", value: "Trench"),
    DropDownValue(id: "3", value: "Bump"),
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Drive Ability:", style: styleBodyTextTheme),
                      DropDownIndexedWidget(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      DropDownIndexedWidget(
                        value: widget.matchScoutingData.commIdFieldAccess,
                        title: null,
                        dropDownValues: listAccess,
                        onStateChanged: (String value) {
                          setState(() {
                            widget.matchScoutingData.commIdFieldAccess = value;
                            widget.onChange!(widget.matchScoutingData);
                          });
                        },
                      ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Defence Rating:", style: styleBodyTextTheme),
                      DropDownIndexedWidget(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Defence Type:", style: styleBodyTextTheme),
                      DropDownIndexedWidget(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Worked to a Strategy:", style: styleBodyTextTheme),
                      Switch(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Effective Shuttle?:", style: styleBodyTextTheme),
                      Switch(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Crash Recovery:", style: styleBodyTextTheme),
                      Switch(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("System Failure:", style: styleBodyTextTheme),
                      Switch(
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text("Warning:", style: styleBodyTextTheme),
                          Text(
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Highlight Team:", style: styleBodyTextTheme),
                          Text(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Intake from Station:", style: styleBodyTextTheme),
                      Switch(
                        value: widget.matchScoutingData.commFlIntakeStation!,
                        onChanged: (bool value) {
                          setState(() {
                            widget.matchScoutingData.commFlIntakeStation =
                                value;
                            widget.onChange!(widget.matchScoutingData);
                          });
                        },
